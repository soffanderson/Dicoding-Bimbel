  ...
  render() {
    ...
    <div class="flex items-center mx-auto">
        <ul class="flex flex-row mt-0 mr-6 space-x-8 text-md font-bold">
            <li>
                <a href="#" class="text-slate-200 dark:text-white hover:underline" aria-current="page">Recent Update</a>
            </li>
            <li>
                <a href="#" class="text-slate-200 dark:text-white hover:underline">Popular</a>
            </li>
            <li>
                <a href="#" class="text-slate-200 dark:text-white hover:underline">Movies</a>
            </li>
            <li>
                <a href="#" class="text-slate-200 dark:text-white hover:underline">Top Airing</a>
            </li>
        </ul>
    </div>
</div>`;
